...
SPREADS: dict[str, Spread] = {
    ...
    for s in [
        ...
        Spread(
            ...
            # классика: крест слева, вертикальный посох справа;
            # холст сам расширяется до пропорции 4:5, чтобы не резалось
            slots=(
                ...
                Slot("Вы сами", 4.0, 3.45),
                Slot("Окружение", 4.0, 2.30),
                Slot("Надежды и страхи", 4.0, 1.15),
                Slot("Итог", 4.0, 0),
            ),
        ),
    ]
